...
describe('test the link list', () => {
  ...
  it('test the Kmethod()', () => {
    ...
    let listK=new Link();
    expect(listK.head).toBeNull();
    expect(listK.Kmethod(1)).toBe('there is no list');

    listK.append(1);
    listK.append(3);
    listK.append(8);
    listK.append(2);
    expect(listK.Kmethod('x')).toBe('Exception -- not valid number');
    expect(listK.Kmethod(0)).toEqual(2);
    expect(listK.Kmethod(2)).toBe(3);
    expect(listK.Kmethod(6)).toBe('Exception');
